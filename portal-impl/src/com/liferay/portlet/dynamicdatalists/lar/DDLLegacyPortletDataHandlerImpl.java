...
import com.liferay.portlet.dynamicdatamapping.lar.DDMLegacyPortletDataHandlerImpl;
 ...
 */
public class DDLLegacyPortletDataHandlerImpl
	extends BaseLegacyPortletDataHandler implements DDLPortletDataHandler {
	...
	public void exportRecordSet(
		...
		DDMLegacyPortletDataHandlerImpl.exportStructure(
		...
		for (DDMTemplate ddmTemplate : ddmTemplates) {
			DDMLegacyPortletDataHandlerImpl.exportTemplate(
	...
	protected PortletPreferences doDeleteData(
		...
		if (!portletDataContext.addPrimaryKey(
				DDLLegacyPortletDataHandlerImpl.class, "deleteData")) {
	...
	protected void importDDMStructures(
		...
		for (Element ddmStructureElement : ddmStructureElements) {
			DDMLegacyPortletDataHandlerImpl.importStructure(
	...
	protected void importDDMTemplates(
		...
		for (Element ddmTemplateElement : ddmTemplateElements) {
			DDMLegacyPortletDataHandlerImpl.importTemplate(
