...
public class AssetLinkLocalServiceWrapper implements AssetLinkLocalService,
	...
	* @throws SystemException if a system exception occurred
	*/
	public long[] getLinkIds(long entryId, int typeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _assetLinkLocalService.getLinkIds(entryId, typeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public long[] getLinkIds(long entryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _assetLinkLocalService.getLinkIds(entryId);
	}
