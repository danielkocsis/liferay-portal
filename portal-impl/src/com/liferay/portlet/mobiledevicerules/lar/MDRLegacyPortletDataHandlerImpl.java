 ...
 */
public class MDRLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected PortletPreferences doDeleteData(
		...
		if (!portletDataContext.addPrimaryKey(
				MDRLegacyPortletDataHandlerImpl.class, "deleteData")) {
	...
	private static Log _log = LogFactoryUtil.getLog(
		MDRLegacyPortletDataHandlerImpl.class);
