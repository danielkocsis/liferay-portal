 ...
 */
public class PollsDisplayLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected String doExportData(
		...
		PollsLegacyPortletDataHandlerImpl.exportQuestion(
	...
	protected PortletPreferences doImportData(
		...
		for (Element questionElement : questionsElement.elements("question")) {
			...
			PollsLegacyPortletDataHandlerImpl.importQuestion(
		...
		for (Element choiceElement : choicesElement.elements("choice")) {
			...
			PollsLegacyPortletDataHandlerImpl.importChoice(
		...
		if (portletDataContext.getBooleanParameter(_NAMESPACE, "votes")) {
			...
			for (Element voteElement : votesElement.elements("vote")) {
				...
				PollsLegacyPortletDataHandlerImpl.importVote(
	...
	private static Log _log = LogFactoryUtil.getLog(
		PollsDisplayLegacyPortletDataHandlerImpl.class);
