...
<%
String cssClass = "staging-icon-menu " + GetterUtil.getString((String) request.getAttribute("liferay-staging:staging-menu:cssClass"));
boolean extended = GetterUtil.getBoolean((String)request.getAttribute("liferay-staging:staging-menu:extended"));
long groupId = GetterUtil.getLong((String)request.getAttribute("liferay-staging:staging-menu:groupId"));
String icon = GetterUtil.getString((String)request.getAttribute("liferay-staging:staging-menu:icon"));
long layoutSetBranchId = GetterUtil.getLong((String)request.getAttribute("liferay-staging:staging-menu:layoutSetBranchId"));
String message = GetterUtil.getString((String)request.getAttribute("liferay-staging:staging-menu:message"));
boolean onlyActions = GetterUtil.getBoolean((String)request.getAttribute("liferay-staging:staging-menu:onlyActions"));
boolean privateLayout = GetterUtil.getBoolean((String)request.getAttribute("liferay-staging:staging-menu:privateLayout"));
long selPlid = GetterUtil.getLong((String)request.getAttribute("liferay-staging:staging-menu:selPlid"));
boolean showManageBranches = GetterUtil.getBoolean((String)request.getAttribute("liferay-staging:staging-menu:showManageBranches"));
...
<c:if test="<%= stagingGroup != null %>">
	<c:choose>
		<c:when test="<%= onlyActions %>">
			<%@ include file="/html/taglib/staging/staging_menu/staging_actions.jspf" %>
		</c:when>
		<c:otherwise>
			<aui:nav-bar>
				<aui:nav>
