 ...
 * @author Raymond Augé
 */
public class DLDisplayLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected String doExportData(
		...
		if (rootFolderId == DLFolderConstants.DEFAULT_PARENT_FOLDER_ID) {
			...
			for (Folder folder : folders) {
				DLLegacyPortletDataHandlerImpl.exportFolder(
	...
	protected PortletPreferences doImportData(
		...
		for (Element fileEntryTypeElement : fileEntryTypeElements) {
			DLLegacyPortletDataHandlerImpl.importFileEntryType(
		...
		if (portletDataContext.getBooleanParameter(_NAMESPACE, "shortcuts")) {
			...
			for (Element fileShortcutElement : fileShortcutElements) {
				DLLegacyPortletDataHandlerImpl.importFileShortcut(
