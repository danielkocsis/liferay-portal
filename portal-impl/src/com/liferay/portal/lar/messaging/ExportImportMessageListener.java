...
public abstract class ExportImportMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (message.getDestinationName().equals(DestinationNames.EXPORT)) {
			isExport = true;
		}

		logMessage(exportImportMessage, isExport);
	...
	protected void logMessage(
		ExportImportMessage exportImportMessage, boolean export) {
