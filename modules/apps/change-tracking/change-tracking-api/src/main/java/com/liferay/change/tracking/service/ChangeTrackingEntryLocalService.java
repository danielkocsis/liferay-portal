...
/**
 * Provides the local service interface for ChangeTrackingEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChangeTrackingEntryLocalServiceUtil
...
public interface ChangeTrackingEntryLocalService extends BaseLocalService,
	PersistedModelLocalService, PersistedResourcedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChangeTrackingEntryLocalServiceUtil} to access the change tracking entry local service. Add custom service methods to {@link com.liferay.change.tracking.service.impl.ChangeTrackingEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ChangeTrackingEntry addEntry(long companyId, long userId,
