...
public class SystemEventAdvice
	...
	public void afterReturning(MethodInvocation methodInvocation, Object result)
		...
		if (systemEvent.referred() && (groupedModel instanceof TypedModel)) {
			referrerClassName = ((TypedModel)groupedModel).getClassName();
		}
		...
		if (hierarchyEntry != null) {
			SystemEventLocalServiceUtil.addSystemEvent(
				groupedModel.getGroupId(), hierarchyEntry.getClassName(),
				(Long)primaryKeyObj, hierarchyEntry.getUuid(),
			...
			SystemEventLocalServiceUtil.addSystemEvent(
				...
				(Long)primaryKeyObj, getUuid(groupedModel), referrerClassName,
	...
	public Object before(MethodInvocation methodInvocation) throws Throwable {
		...
		if (systemEvent.childAction() != SystemEventConstants.ACTION_NONE) {
			...
			if (hierarchyEntry != null) {
				hierarchyEntry.setUuid(getUuid(groupedModel));
			}
		}
