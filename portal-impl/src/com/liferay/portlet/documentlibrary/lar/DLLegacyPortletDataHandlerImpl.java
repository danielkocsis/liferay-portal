 ...
 * @author Raymond Augé
 */
public class DLLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected PortletPreferences doDeleteData(
		...
		if (!portletDataContext.addPrimaryKey(
				DLLegacyPortletDataHandlerImpl.class, "deleteData")) {
	...
	private static Log _log = LogFactoryUtil.getLog(
		DLLegacyPortletDataHandlerImpl.class);
