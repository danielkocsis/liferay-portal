...
public interface CTDefinitionRegistrar {
	 ...
	 *
	 * @param ctConfiguration The change tracking definition object to be
	 *        registered
	 */
	public void register(CTDefinition<?, ?> ctConfiguration);
	 ...
	 *        unregistered
	 */
	public void unregister(CTDefinition<?, ?> ctConfiguration);
