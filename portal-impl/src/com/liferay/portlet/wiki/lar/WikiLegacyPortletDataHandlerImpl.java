 ...
 */
public class WikiLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected static void exportPage(
		...
		if (portletDataContext.isPathNotProcessed(path)) {
			...
			String content =
				JournalLegacyPortletDataHandlerImpl.exportReferencedContent(
	...
	protected PortletPreferences doDeleteData(
		...
		if (!portletDataContext.addPrimaryKey(
				WikiLegacyPortletDataHandlerImpl.class, "deleteData")) {
