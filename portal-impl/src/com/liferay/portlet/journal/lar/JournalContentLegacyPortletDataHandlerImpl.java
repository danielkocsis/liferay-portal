 ...
 *
 * <p>
 * This <code>LegacyPortletDataHandler</code> differs from from
 * <code>JournalLegacyPortletDataHandlerImpl</code> in that it only exports articles
 * referenced in Journal Content portlets. Articles not displayed in Journal
 * Content portlets will not be exported unless
 * <code>JournalLegacyPortletDataHandlerImpl</code> is activated.
 * </p>
 *
 ...
 * @see    JournalLegacyPortletDataHandlerImpl
 */
public class JournalContentLegacyPortletDataHandlerImpl
	...
	public PortletDataHandlerControl[] getExportMetadataControls() {
		return new PortletDataHandlerControl[] {
			 new PortletDataHandlerBoolean(
				...
				JournalLegacyPortletDataHandlerImpl.getMetadataControls()),
			new PortletDataHandlerBoolean(
				_NAMESPACE, "folders-and-documents", true,
				DLLegacyPortletDataHandlerImpl.getMetadataControls()
			)
		};
	}
	...
	private static Log _log = LogFactoryUtil.getLog(
		JournalContentLegacyPortletDataHandlerImpl.class);
