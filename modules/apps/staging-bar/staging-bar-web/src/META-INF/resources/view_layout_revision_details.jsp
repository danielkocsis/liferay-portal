...
<portlet:renderURL var="viewHistoryURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	...
	<portlet:param name="layoutSetBranchId" value="<%= Long.toString(layoutSetBranch.getLayoutSetBranchId()) %>" />
	<portlet:param name="plid" value="<%= Long.toString(layoutRevision.getPlid()) %>" />
