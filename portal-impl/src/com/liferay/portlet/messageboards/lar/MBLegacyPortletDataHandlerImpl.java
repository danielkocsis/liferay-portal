 ...
 * @author Raymond Augé
 */
public class MBLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected PortletPreferences doDeleteData(
		...
		if (!portletDataContext.addPrimaryKey(
				MBLegacyPortletDataHandlerImpl.class, "deleteData")) {
	...
	private static Log _log = LogFactoryUtil.getLog(
		MBLegacyPortletDataHandlerImpl.class);
