...
public class ExportImportLifecycleEventFactoryUtil {
	...
	public static ExportImportLifecycleEvent createLifecycleEvent(
		int eventCode, Serializable... attributes) {

		return getExportImportLifecycleEventFactory().
			createExportImportLifecycleEvent(eventCode, attributes);
	}
