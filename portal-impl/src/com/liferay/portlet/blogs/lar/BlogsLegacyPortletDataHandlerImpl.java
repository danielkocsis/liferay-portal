 ...
 */
public class BlogsLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	protected PortletPreferences doDeleteData(
		...
		if (!portletDataContext.addPrimaryKey(
				BlogsLegacyPortletDataHandlerImpl.class, "deleteData")) {
	...
	protected void exportEntry(
		...
		String content = JournalLegacyPortletDataHandlerImpl.exportReferencedContent(
	...
	protected void importEntry(
		...
		String content = JournalLegacyPortletDataHandlerImpl.importReferencedContent(
