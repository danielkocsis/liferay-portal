...
public class ColorSchemeFactoryUtil {
	...
	public static ColorScheme getDefaultColorScheme() {
		return getColorSchemeFactory().getDefaultColorScheme();
	}

	public static ColorScheme getDefaultColorScheme(boolean wapTheme) {
		return getColorSchemeFactory().getDefaultColorScheme(wapTheme);
	}
