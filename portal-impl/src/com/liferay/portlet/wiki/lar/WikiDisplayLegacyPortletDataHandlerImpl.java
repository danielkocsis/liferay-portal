 ...
 */
public class WikiDisplayLegacyPortletDataHandlerImpl extends BaseLegacyPortletDataHandler {
	...
	public PortletDataHandlerControl[] getExportMetadataControls() {
		return new PortletDataHandlerControl[] {
			new PortletDataHandlerBoolean(
				...
				WikiLegacyPortletDataHandlerImpl.getMetadataControls()
			)
		};
	}
	...
	protected String doExportData(
		...
		WikiLegacyPortletDataHandlerImpl.exportNode(
	...
	protected PortletPreferences doImportData(
		...
		for (Element nodeElement : nodesElement.elements("node")) {
			...
			WikiLegacyPortletDataHandlerImpl.importNode(portletDataContext, node);
		}
		...
		for (Element pageElement : pagesElement.elements("page")) {
			...
			WikiLegacyPortletDataHandlerImpl.importPage(
	...
	private static Log _log = LogFactoryUtil.getLog(
		WikiDisplayLegacyPortletDataHandlerImpl.class);
